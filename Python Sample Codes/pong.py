...
class Point:
    def __init__(self):
        self.x = 1
        self.y = float(random.uniform(1,300))
...
class Ball:
    ...
    def draw(self):
        arcade.draw_ellipse_filled(self.center.x,self.center.y,BALL_RADIUS,BALL_RADIUS,arcade.color.GREEN,0,-1)
...
class Paddle:
    ...
    def __init__(self):
        self.center = Point()
        self.center.x = 400
        self.center.y = float(random.uniform(1,300))

    def draw(self):
        arcade.draw_rectangle_filled(self.center.x,self.center.y,PADDLE_WIDTH,PADDLE_HEIGHT,color=arcade.color.RED,tilt_angle=0)
