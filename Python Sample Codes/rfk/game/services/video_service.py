...
class VideoService:
    ...
    def clear_buffer(self):
        ...
        """
        arcade.begin_drawing()
        arcade.clear_background(arcade.BLACK)
        if self._debug == True:
            self._draw_grid()
    ...
    def draw_actor(self, actor):
        ...
        arcade.draw_text(text, x, y, font_size, color)
    ...
    def is_window_open(self):
        ...
        """
        return not arcade.window_should_close()
    ...
    def open_window(self):
        ...
        """
        arcade.init_window(self._width, self._height, self._caption)
        arcade.set_target_fps(self._frame_rate)

    def _draw_grid(self):
        """Draws a grid on the screen."""
        for y in range(0, self._height, self._cell_size):
            arcade.draw_line(0, y, self._width, y, arcade.GRAY)
        for x in range(0, self._width, self._cell_size):
            arcade.draw_line(x, 0, x, self._height, arcade.GRAY)